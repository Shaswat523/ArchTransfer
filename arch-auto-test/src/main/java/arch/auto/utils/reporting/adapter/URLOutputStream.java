 ...
 * Original source: https://github.com/extent-framework/extentreports-cucumber4-adapter/blob/master/src/main/java/com/aventstack/extentreports/cucumber/adapter/URLOutputStream.java
 *
        ...
        if (responseCode != expectedResponseCode) {
          try {
            ...
            if (errorStream != null) {
              ...
              throw new ResponseException(responseBody, expected,
