package arch.auto.utils.selenium;
...
public class PageObjectUtil {
    ...
    public WebDriverWait getWait(long... maxWaitLimit) {
        ...
        return new WebDriverWait(getDriver(), Duration.ofSeconds(maxWaitLimit.length>0 ? maxWaitLimit[0]: getWaitDuration()));
    }
...
//        (new WebDriverWait(DriverFactory.getInstance().getDriver(), Duration.ofSeconds(timeOutInSeconds)))
